...
| 平台    | 架构        | 格式 | 下载                                                         | 版本  | 备注                              |
| ------- | ----------- | ---- | ------------------------------------------------------------ | ----- | --------------------------------- |
| Windows | x86_64      | exe  | [下载](https://download.clipshare.coclyun.top/releases/clipshare/1.2.1/clipshare-1.2.1+19-windows-setup.exe) | 1.2.1 | 安装版，仅支持 Windows10+         |
| Windows | x86_64      | zip  | [下载](https://download.clipshare.coclyun.top/releases/clipshare/1.2.1/clipshare-1.2.1+19-windows.zip) | 1.2.1 | 便携版，仅支持 Windows10+         |
| Android | arm64-v8a   | apk  | [下载](https://download.clipshare.coclyun.top/releases/clipshare/1.2.0/app-arm64-v8a-release-v1.2.0.apk) | 1.2.0 | 要求`Android 7.0`及以上系统版本。 |
